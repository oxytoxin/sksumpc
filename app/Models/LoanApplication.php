    ...
    class LoanApplication extends Model
    {
        ...
        public function getStatusNameAttribute()
        {
            return match ($this->status) {
                self::STATUS_PROCESSING, self::STATUS_APPROVED => 'On Process',
        ...
        protected static function booted(): void
        {
            ...
            static::updating(function (LoanApplication $loanApplication) {
                $loanApplication->monthly_payment = LoansProvider::computeMonthlyPayment($loanApplication->desired_amount, $loanApplication->loan_type, $loanApplication->number_of_terms, config('app.transaction_date') ?? today());
            });
