...
class MembersReport extends Page
{
    ...
    public function members()
    {
        $members = Member::query()
            ->whereNot('member_type_id', MemberTypes::ORGANIZATION->value)
            ...
            ->with(['patronage_status', 'credit_and_background.civil_status', 'credit_and_background.occupation', 'gender', 'member_type', 'division'])
