<?php
    ...
    class LoanBillingPayments extends Page implements HasTable, HasSchemas
    {
        use InteractsWithTable, InteractsWithSchemas;

        protected static string $resource = LoanBillingResource::class;

        protected string $view = 'filament.app.resources.loan-billing-resource.pages.loan-billing-payments';
