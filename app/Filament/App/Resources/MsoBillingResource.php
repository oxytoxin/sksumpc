<?php
    ...
    use App\Filament\App\Resources\MsoBillingResource\Pages\PrintMsoBilling;
    ...
    class MsoBillingResource extends Resource
    {
            ...
            return $table
                ...
                ->recordActions([
                    ...
                    Action::make('billing_receivables')
                        ...
                        ->outlined(),
                    Action::make('print')
                        ->url(fn($record) => route('filament.app.resources.mso-billings.statement-of-remittance', ['mso_billing' => $record]))
        ...
        public static function getPages(): array
        {
            return [
                ...
                'statement-of-remittance' => PrintMsoBilling::route('/{mso_billing}/statement-of-remittance'),
            ];
        }
    }
