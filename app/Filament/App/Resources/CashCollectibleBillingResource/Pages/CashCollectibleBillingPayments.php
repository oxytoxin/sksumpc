<?php
    ...
    class CashCollectibleBillingPayments extends Page implements HasTable, HasSchemas
    {
        use InteractsWithTable, InteractsWithSchemas;

        protected static string $resource = CashCollectibleBillingResource::class;

        protected string $view = 'filament.app.resources.cash-collectible-billing-resource.pages.cash-collectible-billing-payments';
