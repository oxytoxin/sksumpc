...
use App\Filament\App\Resources\CapitalSubscriptionBillingResource\Pages\PrintCapitalSubscriptionBilling;
...
class CapitalSubscriptionBillingResource extends Resource
{
        ...
        return $table
            ...
            ->recordActions([
                ...
                Action::make('billing_receivables')
                    ...
                    ->outlined(),
                Action::make('print')
                    ->url(fn ($record) => route('filament.app.resources.capital-subscription-billings.statement-of-remittance', ['capital_subscription_billing' => $record]))
    ...
    public static function getPages(): array
    {
        return [
            ...
            'statement-of-remittance' => PrintCapitalSubscriptionBilling::route('/{capital_subscription_billing}/statement-of-remittance'),
        ];
    }
}
