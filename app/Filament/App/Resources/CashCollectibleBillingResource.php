...
use App\Filament\App\Resources\CashCollectibleBillingResource\Pages\PrintCashCollectibleBilling;
...
class CashCollectibleBillingResource extends Resource
{
        ...
        return $table
            ...
            ->recordActions([
                ...
                Action::make('billing_receivables')
                    ...
                    ->outlined(),
                Action::make('print')
                    ->url(fn ($record) => route('filament.app.resources.cash-collectible-billings.statement-of-remittance', ['cash_collectible_billing' => $record]))
    ...
    public static function getPages(): array
    {
        return [
            ...
            'statement-of-remittance' => PrintCashCollectibleBilling::route('/{cash_collectible_billing}/statement-of-remittance'),
        ];
    }
}
