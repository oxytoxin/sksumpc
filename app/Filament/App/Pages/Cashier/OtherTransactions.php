...
class OtherTransactions extends  Component implements HasActions, HasForms
{
    ...
    {
        return $this->generateForm($form, $this->transaction_date, CashCollectible::where('cash_collectible_category_id', 3)->pluck('name', 'id'));
    }
    ...
    {
        return view('filament.app.pages.cashier.other-transactions');
    }
