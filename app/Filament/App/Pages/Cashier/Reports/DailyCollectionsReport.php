<?php
    ...
    class DailyCollectionsReport extends Page implements HasForms
    {
        ...
        public function form(Schema $schema): Schema
        {
            return $schema
                ->components([
                    DatePicker::make('transaction_date')->default(config('app.transaction_date')),
                ])
                ->columns(4)
                ->live();
        }
        ...
        public function GeneralFundDeposits()
        {
            return Transaction::whereHas('account', function ($q1) {
                ...
                ->whereDate('transaction_date', $this->transaction_date)
                ->sum('credit');
        }
