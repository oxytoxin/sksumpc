<?php
    ...
    class MsoTransactions extends Page implements HasTable
    {
        ...
        public function table(Table $table): Table
        {
            return $table
                ->query(
                    fn() => Transaction::whereDoesntHave('account', function ($query) {
                        return $query->whereHas(
                            'ancestorsAndSelf',
                            fn($q) => $q->whereIn('id', [
                                OthersTransactionExcludedAccounts::TIME_DEPOSITS->value,
                                OthersTransactionExcludedAccounts::CASH_AND_CASH_EQUIVALENTS->value,
                                OthersTransactionExcludedAccounts::TIME_DEPOSIT_INTEREST_EXPENSE->value
                            ])
                        );
                    })
