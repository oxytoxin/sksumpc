...
return new class extends Migration
{
    ...
    {
        Schema::create('cash_collectible_billings', function (Blueprint $table) {
            $table->id();
            $table->date('date');
            $table->foreignIdFor(CashCollectible::class)->constrained();
    ...
    {
        Schema::dropIfExists('cash_collectible_billings');
    }
};
