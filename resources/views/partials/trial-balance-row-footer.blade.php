...
<tfoot>
    <tr class="hover:bg-green-100">
        ...
        <td class="whitespace-nowrap border border-black px-2 text-right text-xs font-bold uppercase hover:bg-green-300">
    ...
    <tr>
        ...
        <td class="whitespace-nowrap border border-black px-2 text-right text-xs font-bold uppercase hover:bg-green-300" colspan="2">
