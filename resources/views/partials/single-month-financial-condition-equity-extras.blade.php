...
<tr>
    ...
    <td colspan="2" class="fs-row-data !text-center">
        {{ renumber_format(175512000 - $children_accounts->whereIn('id', [98, 99])->sum('ending_balance_credit')) }}
    </td>
    <td class="fs-row-data !text-center">
    </td>
</tr>
...
<tr>
    ...
    <td colspan="2" class="fs-row-data !text-center">
        {{ renumber_format(12616000 - $children_accounts->where('id', 100)->sum('ending_balance_credit')) }}
    </td>
    <td class="fs-row-data !text-center">
    </td>
</tr>
