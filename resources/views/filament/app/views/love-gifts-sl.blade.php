...
<div x-data>
    <div class="p-4 print:text-[10pt] print:leading-tight print:w-full" x-ref="print">
        ...
        <h4 class="text-3xl text-center mt-4 print:text-[14pt] font-bold">SUBSIDIARY LEDGER FOR LOVE GIFTS</h4>
        <div class="my-4">
    ...
    <div class="p-4 flex justify-end">
        <x-filament::button icon="heroicon-o-printer"
            @click="printOut($refs.print.outerHTML, 'Love Gifts Subsidiary Ledger')">Print</x-filament::button>
    </div>
</div>
