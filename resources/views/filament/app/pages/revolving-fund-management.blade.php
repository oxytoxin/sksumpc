    ...
    <table>
        ...
        <tfoot>
            <tr>
                ...
                <td class="border border-black px-4 text-right font-bold">{{ renumber_format($this->table->getRecords()->sum('withdrawal')) }}</td>
                <td class="border border-black px-4 text-right font-bold">{{ renumber_format($this->table->getRecords()->sum('deposit')) }}</td>
