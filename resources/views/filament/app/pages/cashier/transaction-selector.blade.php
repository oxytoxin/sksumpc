<div class="flex justify-center">
    <details class="mb-2 mx-auto">
        ...
        <ul class="ml-2 space-y-2">
            @if($member)
                <li>
                    <button data-transaction="cbu" wire:click="addTransaction('cbu')" class="text-left py-2 px-4 rounded-lg w-full cursor-pointer shadow font-semibold">
                        CBU
                    </button>
                </li>
                <li>
            ...
            @endif
            <li>
                <button data-transaction="cash-collection" wire:click="addTransaction('cash_collection')" class="text-left py-2 px-4 rounded-lg w-full cursor-pointer shadow font-semibold">
                    CASH COLLECTIBLES
                </button>
            </li>
            <li>
