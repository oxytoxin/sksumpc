<x-app.cashier.reports.report-layout :signatories="$this->getSignatories()" :title="$report_title">
    <table class="doc-table">
        ...
        <tr>
            ...
            <th class="doc-table-header-cell">TOTAL AMOUNT</th>
        ...
        <tr class="doc-table-row-total">
            ...
            {{-- <td class="doc-table-cell-center font-bold">{{ renumber_format($total_debit, 2) }}</td> --}}
            <td class="doc-table-cell-center font-bold">{{ renumber_format($total_credit, 2) }}</td>
