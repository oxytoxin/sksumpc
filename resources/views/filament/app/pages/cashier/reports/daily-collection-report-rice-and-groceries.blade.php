<x-filament-panels::page>
    <x-app.cashier.reports.report-layout :signatories="$signatories" title="DAILY COLLECTION REPORT OF RICE AND GROCERIES">
        <table class="w-full">
            <thead>
                <tr>
                    ...
                    <th class="text-center border border-black">RICE</th>
                    <th class="text-center border border-black">GROCERIES</th>
            ...
            <tbody>
                ...
                @forelse ($this->payments as $payment)
                    <tr>
                        ...
                        @if ($payment->cash_collectible_id == 1)
                        ...
                        @endif
                        @if ($payment->cash_collectible_id == 2)
                            <td class="text-center px-2 border border-black">{{ number_format($payment->amount, 2) }}</td>
                        @else
                            <td class="text-center px-2 border border-black"></td>
                        @endif
                ...
                <tr>
                    ...
                    <th class="text-center border border-black">TOTAL</th>
                    <th class="text-center border border-black"></th>
                    <th class="text-center border border-black">{{ number_format($this->payments->where('cash_collectible_id', 1)->sum('amount'), 2) }}</th>
                    <th class="text-center border border-black">{{ number_format($this->payments->where('cash_collectible_id', 2)->sum('amount'), 2) }}</th>
