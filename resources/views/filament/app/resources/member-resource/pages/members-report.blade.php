<x-filament-panels::page>
    <x-app.cashier.reports.report-layout>
        <div class="flex flex-col items-center">
            ...
            <table class="w-full text-xs print:text-[7pt] mt-4">
                <thead>
                <tr>
                ...
                @foreach ($this->members as $member)
                    <tr>
                        ...
                        <td class="whitespace-nowrap border border-black px-2">{{ $member->member_type?->name }}
                        </td>
                        <td class="whitespace-nowrap border border-black px-2">
                        ...
                        <td class="whitespace-nowrap border border-black px-2">
                            {{ $member->membership_date?->format('m/d/Y') }}</td>
                    </tr>
                @endforeach
                </tbody>
            </table>
