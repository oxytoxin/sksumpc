    ...
    <div x-data class="mx-auto">
        <div class="p-4 print:w-full print:text-[8pt] print:leading-tight" x-ref="print">
            ...
            <div class="break-before-page">
                ...
                <div class="mt-12 grid grid-cols-2 gap-x-32 gap-y-12">
                    <div>
            ...
            <div>
                <h1 class="my-8 text-center font-bold">DEED OF ASSIGNMENT</h1>
                ...
                <h3 class="mt-4 text-center font-bold">Signed in the presence of:</h3>
                <div class="mt-12 grid grid-cols-2 gap-x-32 gap-y-12">
                    <div>
