...
<x-filament-panels::page>
    <div x-data class="mx-auto">
        <div class="p-4 print:text-[8pt] print:leading-tight print:w-full" x-ref="print">
                    ...
                    <div>
                        <table class="w-full print:text-[9pt]">
                            ...
                            <tbody>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="8" class="border border-black px-2 text-center">No loan
            ...
            <div class="break-before-page">
                ...
                <div class="flex-col flex gap-y-4">
                    ...
                    <p class="indent-8">
                        In case of any default in payments as herein agreed, the entire balance of this note shall
                        become
                    ...
                    <p class="indent-8">
                        In case of judicial action of this obligation or any part of it, the debtor waives all his
                        rights
            ...
            <div>
                <h1 class="text-center font-bold my-8">DEED OF ASSIGNMENT</h1>
        ...
        <div class="p-4 flex justify-end space-x-2">
            <x-filament::button outlined tag="a"
                href="{{ route('filament.app.resources.loan-applications.index') }}">Back to Loan
                Applications</x-filament::button>
            <x-filament::button icon="heroicon-o-printer"
                @click="printOut($refs.print.outerHTML, 'Loan Application Form')">Print</x-filament::button>
        </div>
    </div>
</x-filament-panels::page>
