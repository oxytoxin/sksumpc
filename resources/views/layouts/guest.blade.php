...
<body class="font-sans text-gray-900 antialiased">
    <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0">
        ...
        <div class="space-y-2">
            ...
            <x-login-link email="crecomsecretary@gmail.com" label="Login as crecom secretary" />
            <x-login-link email="crecomvicechairperson@gmail.com" label="Login as crecom vice chairperson" />
            <x-login-link email="crecomchairperson@gmail.com" label="Login as crecom chairperson" />
            <x-login-link email="bodchairperson@gmail.com" label="Login as bod chairperson" />
        </div>
        @endenv
