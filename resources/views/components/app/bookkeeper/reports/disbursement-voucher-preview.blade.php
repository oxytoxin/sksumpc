...
<div x-data>
    <table class="w-full border-2 border-black font-serif" x-ref="print">
        ...
        <tr>
            <td class="text-center text-sm font-bold" colspan="6">SULTAN KUDARAT STATE UNIVERSITY MULTI - PURPOSE
                COOPERATIVE
            </td>
        </tr>
        <tr>
        ...
        <tr class="border-x-2 border-t-2 border-black">
            ...
            <td class="border-r-2 border-t border-black px-2 text-base font-semibold"
                colspan="3">{{ $disbursement_voucher->name }}</td>
        ...
        <tr class="border-x-2 border-b-2 border-black">
            ...
            <td class="border-t border-black px-2"
                colspan="1">{{ $disbursement_voucher->transaction_date->format('m/d/Y') }}</td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="whitespace-nowrap border-b border-black px-2 pt-4">Check No. <span
                        class="px-4">{{ $disbursement_voucher->check_number }}</span></td>
            <td class="whitespace-nowrap border-b border-r border-black px-2 pt-4">Amount P<span
                        class="px-4">{{ number_format($disbursement_voucher_items->last()->credit, 2) }}</span>
            </td>
    ...
    <div class="flex justify-end p-4">
        <x-filament::button icon="heroicon-o-printer" @click="printOut($refs.print.outerHTML, 'Disbursement Voucher')">
            Print
        </x-filament::button>
    </div>
</div>
