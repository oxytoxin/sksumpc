<div x-data>
    <table x-ref="print" class="w-full border-2 border-black font-serif">
        ...
        <tr class="border-x-2 border-t-2 border-black">
            ...
            <td colspan="2"
                class="border-t border-black px-2">{{ $journal_entry_voucher->transaction_date->format('m/d/Y') }}</td>
        </tr>
        <tr class="border-x-2 border-b-2 border-black">
            ...
            <td colspan="2"
                class="border-t font-bold border-black px-2">{{ $journal_entry_voucher->reference_number }}</td>
        </tr>
        <tr>
            <td colspan="6">&nbsp</td>
        </tr>
    ...
    <div class="flex justify-end p-4">
        <x-filament::button icon="heroicon-o-printer" @click="printOut($refs.print.outerHTML, 'Journal Entry Voucher')">
            Print
        </x-filament::button>
    </div>
</div>
